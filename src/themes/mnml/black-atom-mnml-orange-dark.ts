...
const primaries: Theme.Primaries = {
    d10: oklch(0.25, 0.03, 235),
    d20: oklch(0.30, 0.03, 235),
    d30: oklch(0.35, 0.03, 235),
    d40: oklch(0.40, 0.03, 235),
    ...
    l10: oklch(0.75, 0.05, 235),
    l20: oklch(0.80, 0.05, 235),
    l30: oklch(0.85, 0.05, 235),
    l40: oklch(0.90, 0.05, 235),
};

const accents: Theme.MnmlAccents = {
    a10: oklch(0.75, 0.175, 60.0),
    a20: oklch(0.70, 0.180, 50.0),
