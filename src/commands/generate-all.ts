...
/**
 * Generate themes for all adapters and commit changes if detected.
 * 
    ...
    for (const adapter of config.adapters) {
        ...
        try {
            ...
            if (gitStatus.trim() !== "") {
                ...
                const commitMessage = `chore: update ${adapter} themes with latest core definitions`;
                await runCommand([
                    "git", "commit", "-m", commitMessage,
                    "-m", "Auto-generated by black-atom-core generate-all",
                    "-m", `🤖 Generated with black-atom-core`
                ]);
