...
export function GoSnippet() {
    return (
        <CodeBlock>
            ...
            <span style={s("punctuation-bracket")}>)</span>
            {"\n\n"}
            <span style={s("comment-doc")}>{"// Handler defines the request handler interface."}</span>
            {"\n"}
            ...
            <span style={s("punctuation-bracket")}>{"}"}</span>
            {"\n\n"}
            <span style={s("comment-default")}>{"// Start launches the server and returns any errors."}</span>
            {"\n"}
